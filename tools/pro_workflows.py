...
<body>
  <header class="site-header">
    <h1>{project_name}</h1>
    <p>Wiqo Professional Scaffold ({actual_stack})</p>
  </header>
...
"""
  ...
  console.log("Wiqo scaffold ready");
});
"""
...
"""
  ...
  return (
    <main style={{{{padding: '32px', fontFamily: 'Avenir Next, Segoe UI, sans-serif'}}}}>
      <h1>{project_name}</h1>
      <p>Wiqo React professional scaffold hazır.</p>
    </main>
  )
}}
"""
...
<html lang="tr">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Wiqo React Scaffold</title>
  </head>
  <body>
    <div id="root"></div>
...
"""
  ...
  return (
    <main style={{{{padding: '32px', fontFamily: 'Avenir Next, Segoe UI, sans-serif'}}}}>
      <h1>{project_name}</h1>
      <p>Wiqo Next.js professional scaffold hazır.</p>
    </main>
  )
}}
"""
