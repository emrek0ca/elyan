...
for migration in \
  drizzle/0048_push_delivery.sql \
  drizzle/0049_proactive_autonomy.sql \
  drizzle/0050_proactive_events.sql; do
...
echo "==> Push delivery + proactive autonomy schema bootstrap complete"
