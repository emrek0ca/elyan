...
export function renderPlanningFewShots(): string {
  return [
    ...
    '{"id":"s3","capability":"document_write","args":{"title":"Savunma Dilekcesi Taslagi","content":"Dosya baglami: {{steps.s1.output}}\\n\\nPublic arastirma: {{steps.s2.output}}\\n\\nBu iki baglami kullanarak savunma dilekcesi taslagi hazirla.","format":"docx"},"dependsOn":["s1","s2"],"description":"Ozel dosya ve public arastirmadan dilekce taslagi yaz"}',
    "]}",
    "",
    ...
    '{"id":"s2","capability":"document_write","args":{"title":"Tahlil Yorum Raporu","content":"Okunan veri uzerinden analiz raporu hazirla.\\n\\nVeri: {{steps.s1.output}}","format":"docx"},"dependsOn":["s1"],"description":"Okunan veriyi rapora donustur"}',
    "]}",
    "",
