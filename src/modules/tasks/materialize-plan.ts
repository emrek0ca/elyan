...
export function buildPlanningPrompt(
  ...
  return [
    ...
    "- If text_analyze is available and the task asks to analyze/interpret/evaluate before producing an artifact, insert text_analyze between gathering/calculation/research and the writer. Its sourceContext must reference prior outputs with {{steps.<id>.output}}, and the writer must consume {{steps.<analysis_id>.output}}.",
