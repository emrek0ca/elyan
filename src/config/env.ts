...
const envSchema = z.object({
  ...
  // ÖĞRENİLMİŞ DERLEYİCİ. Kapalı doğar: açıkken bile şablonlar yalnız
  // GÖLGEDE çalışır — yürütmeyi değiştirmek ayrı bir manuel yayın kararıdır.
  ELYAN_LEARNED_COMPILER_ENABLED: booleanFlag(false),
...
export type AppEnv = ParsedEnv & {
  ...
  ELYAN_LEARNED_COMPILER_ENABLED: boolean;
...
export function loadEnv(source: NodeJS.ProcessEnv = process.env): AppEnv {
  ...
  return {
    ...
    ELYAN_LEARNED_COMPILER_ENABLED: parsed.ELYAN_LEARNED_COMPILER_ENABLED,
