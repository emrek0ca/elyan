...
def _default_auth_url(provider: str) -> str:
    ...
    defaults = {
        ...
        "apple_calendar": "x-apple.systempreferences:com.apple.preference.security?Privacy_Automation",
        "apple_reminders": "x-apple.systempreferences:com.apple.preference.security?Privacy_Automation",
        "apple_notes": "x-apple.systempreferences:com.apple.preference.security?Privacy_Automation",
        "apple_contacts": "x-apple.systempreferences:com.apple.preference.security?Privacy_Automation",
