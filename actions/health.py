...
Veri akisi:
  ...
  → iCloud Drive/Auto Export/elyan/HealthAutoExport-YYYY-MM-DD.json
  → elyan
"""
...
HEALTH_DIR = MOBILE_DOCS / "iCloud~com~ifunography~HealthExport" / "Documents" / "elyan"

# Geriye dönük uyumluluk — eski konumlar
_LEGACY_DIRS = [
    MOBILE_DOCS / "com~apple~CloudDocs" / "Auto Export" / "elyan",
    MOBILE_DOCS / "com~apple~CloudDocs" / "elyan",
]

# Legacy düz dosya
_LEGACY_FILE = MOBILE_DOCS / "com~apple~CloudDocs" / "elyan" / "health_data.json"
...
def get_health_data(query: str = "all") -> str:
    ...
    if not _resolve_file(target_date):
        return (
            ...
            "iCloud Drive > Auto Export > elyan klasörüne export ayarlaman gerekiyor."
        )
