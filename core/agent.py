...
from core.tool_runtime import ExecutionRequest, get_tool_runtime_executor
...
class Agent:
    ...
    async def _execute_tool(
        ...
        *,
        ...
        """Execute a tool through the canonical tool runtime executor."""
        return await get_tool_runtime_executor().execute(
            self,
            ExecutionRequest(
                ...
                action_aliases=dict(ACTION_TO_TOOL),
            ),
        )
