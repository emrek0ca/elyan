"""ELYAN i18n - Internationalization."""

# Re-export legacy functions from core/i18n.py (now shadowed by this package)
import re
import sys
...
def normalize_language_code(code: Optional[str] = None, default: str = "auto") -> str:
    raw = str(code or "").strip().lower()
    if raw in SUPPORTED_LANGUAGES:
        return raw
    aliases = {
        "turkish": "tr", "türkçe": "tr", "english": "en",
